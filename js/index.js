...
const locationBtn = document.querySelector('#search-location');
            ...
            for(let k=0;k<weatherData.forecast.forecastday[a].hour.length;k++){
                data+=`
                  ...
                  <tr class="text-center">
                    <td> <img src="${weatherData.forecast.forecastday[a].hour[k].condition.icon}" alt="" /> </td>
                    <td>${weatherData.forecast.forecastday[a].hour[k].temp_c}</td>
